...
<html>
    <head>
        ...
        <script src="../js/user/user_blogs.js"></script>
        <link href="../css/user/User.css" rel="stylesheet">
        <link href="../css/user/user_blogs.css" rel="stylesheet">
                                ...
                                <div class="row blog_option">
                                    <table class="table blog_option_table">
                                        <tr class="blog_option_tr">
                                            ...
                                            <td class="default"><a href="/CheckTheBlog?index=${status.index}&&flag=2">|编辑|</a></td>
                                            <td class="default" id="delete"><a onclick="deleteBlog(${status.index})">|删除|</a></td>
